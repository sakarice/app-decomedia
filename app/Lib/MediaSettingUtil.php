...
class MediaSettingUtil
{
  ...
  public static function getMediaSettingData($media_id){
    ...
    $media_setting_data = [
        ...
        'isShowImg' => $media_setting->is_show_img,
        'isShowMovie' => $media_setting->is_show_movie,
        'maxAudioNum' => $media_setting->max_audio_num,
        'backgroundType' => $media_setting->background_type,
        'mediaBackgroundColor' => $media_setting->background_color,
        'chatValidFlag' => $media_setting->chat_valid_flag,
