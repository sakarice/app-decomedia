...
<body>
  ...
  <div style="font-size: 40px; text-align: center"><h1 style="margin: 0 0 30px 0">Track{{$createOrEdit}}</h1></div>
    ...
    <div class="upload-wrapper">
      ...
      <div class="button-zone">
        ...
        <div class="submit-wrapper">
          <button class="submitButton" type="submit">Track{{$createOrEdit}}</button>
        </div>
      </div>
    </div>
